...
const BACKER_STEPS = [
  ...
  },
  {
    num: 3,
    title: "Дэмжих",
    desc: "QPay, SocialPay эсвэл олон улсын картаар 256-бит SSL шифрлэлттэй баталгаат системээр аюулгүйгээр дэмжлэгийн мөнгөө шилжүүлнэ.",
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "QPay, SocialPay, Монгол банкны картуудаас гадна Visa болон Mastercard олон улсын карт ашиглаж болно. Бүх гүйлгээ нь 256-бит SSL шифрлэлтээр хамгаалагдсан.",
  },
  {
    q: "Хамгийн бага санхүүжилтийн зорилго хэд байж болох вэ?",
    a: "Хамгийн бага зорилго ₮500,000 байна. Дээд хязгаар байхгүй. Бодитой, хүрч болохуйц зорилго тавихыг зөвлөдөг — хэт өндөр зорилго биелэхгүй байх эрсдэлийг нэмэгдүүлдэг.",
  },
];
